        ...
        <section id="service-page" class="pages service-page">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="block">
                            <img class="img-responsive" src="<?php echo base_url()?>images/team.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <figure class="wow fadeInLeft animated" data-wow-duration="500ms" data-wow-delay="300ms">
                            <div class="img-wrapper">
                                <img src="<?php echo base_url()?>images/portfolio/item-2.jpg" class="img-responsive" alt="this is a title" >
                                <div class="overlay">
                                    <div class="buttons">
                    ...
                    <div class="col-sm-3">
                        <figure class="wow fadeInLeft animated" data-wow-duration="500ms" data-wow-delay="300ms">
                            <div class="img-wrapper">
                                <img src="<?php echo base_url()?>mages/portfolio/item-3.jpg" class="img-responsive" alt="" >
                                <div class="overlay">
                                    <div class="buttons">
                    ...
                    <div class="col-sm-3">
                        <figure class="wow fadeInLeft animated" data-wow-duration="500ms" data-wow-delay="600ms">
                            <div class="img-wrapper">
                                <img src="<?php echo base_url()?>images/portfolio/item-4.jpg" class="img-responsive" alt="" >
                                <div class="overlay">
                                    <div class="buttons">
                                        <a rel="gallery" class="fancybox" href="<?php echo base_url()?>images/portfolio/item-4.jpg">Demo</a>        
                                        <a target="_blank" href="">Details</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div id="clients-logo" class="owl-carousel">
                            <div>
                                <img src="<?php echo base_url()?>images/clients/logo-1.jpg" alt="">
                            </div>
                            <div>
                                <img src="<?php echo base_url()?>images/clients/logo-2.jpg" alt="">
                            </div>
                            <div>
                                <img src="<?php echo base_url()?>images/clients/logo-3.jpg" alt="">
                            </div>
                            <div>
                                <img src="<?php echo base_url()?>images/clients/logo-4.jpg" alt="">
                            </div>
                            <div>
                                <img src="<?php echo base_url()?>images/clients/logo-5.jpg" alt="">
                            </div>
                             <div>
                                <img src="<?php echo base_url()?>images/clients/logo-1.jpg" alt="">
                            </div>
