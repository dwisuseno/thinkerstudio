                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center">
                            ...
                            <h2 class="wow fadeInUp animated" data-wow-delay=".6s">Think Again! Not Found!</h2>
                            ...
                            <a href="<?php echo base_url()?>" class="btn btn-dafault btn-home wow fadeInUp animated" data-wow-delay="1.1s">Go Home</a>
